...
DIRS = {"CXR": (NB/"outputs_cxr_densenet121_v5", "cxr"),
        "ECG": (NB/"outputs_ecg_resnet1d_v3_1", "ecg"),
        "LABS": (NB/"outputs_labs_tabular_v2_2", "labs")}
...
""")
    st.markdown("---")
    st.caption("Modelos solo-CPU: CXR DenseNet121 v5 · ECG ResNet1D v3.1 · Analíticas blend v2.2.")
